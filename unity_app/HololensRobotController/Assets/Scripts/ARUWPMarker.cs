...
public class ARUWPMarker : MonoBehaviour{
    ...
    private Matrix4x4 latestPoseInWorldCoordinates = new Matrix4x4();
    ...
    public bool GetMarkerVisibility() {
        return latestTrackingInfo != null && latestTrackingInfo.visible;
    }
    ...
    /// <summary>
    /// Retrieve the pose of the marker depending on the latest tracking
    /// information. It is correctly adapted to Unity left-hand coordinate system already. Added by Arda.
    /// </summary>
    /// <returns>Matrix4x4 object representing the transformation</returns>
    public Matrix4x4 GetMarkerPoseInWorldCoordinateFrame()
    {
        return latestPoseInWorldCoordinates;
    }
    ...
    private void Start() {
        ...
        if (holoLensCamera == null) {
            ...
            if (!anchoredToWorld) {
                ...
                dummyGameObject.transform.localScale = target.transform.localScale;
            }
        }
